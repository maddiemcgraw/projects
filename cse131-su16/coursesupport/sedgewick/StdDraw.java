...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
	 ...
	 * @param red2 
	 */
	public static void setPenColor(javafx.scene.paint.Color red2) { setPenColor(DEFAULT_PEN_COLOR); }
	/**
	 ...
	 * @param d an array of all the x-coordindates of the polygon
	 * @param e an array of all the y-coordindates of the polygon
	 */
	...
	public static void Square(double d, double e) {
